...
public class SmsNotificationServiceImplTest {
    private SmsNotificationServiceImpl notificationService;
    ...
    public void before() {
        ...
        notificationService = new SmsNotificationServiceImpl(notificationDao, orderDao, shippingDao);
