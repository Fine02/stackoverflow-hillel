...
public class SmsNotificationServiceTest {
    ...
    public void whenNotificationWasNotModifiedThenThrowExeption() {
        ...
        Assertions.assertThrows(ReservationWasNotModifiedException.class, () ->
                new SmsNotificationService().send(flightReservationNotModifiedStatus));
    }
    ...
    public void whenFlightStatusIsCanceledThenReturnFlightReservationInfo() {
        String expected = "FlightReservation{reservationNumber='null', " +
                ...
                "status=CONFIRMED, notifications=null, payment=null, passengers=null}sent by SMS";
        String actual = new SmsNotificationService().send(flightReservationFlightStatusCancelrd);
    ...
    public void whenReservationStatusIsCanceledThenReturnFlightReservationInfo() {
        String expected = "FlightReservation{reservationNumber='null', " +
                ...
                " \"seats\":null, \"aircraft\":null, \"crews\":null, \"pilots\":null}, seatMap=null, " +
                "status=CANCELED, notifications=null, payment=null, passengers=null}sent by SMS";
        String actual = new SmsNotificationService().send(flightReservationReservationStatusCancelrd);
    ...
    public void whenReservationStatusIsAbandonedThenReturnFlightReservationInfo() {
        String expected = "FlightReservation{reservationNumber='null', " +
                ...
                " \"departureTime\": \"null\", \"gate\": \"null\", \"status\":ARRIVED," +
                " \"seats\":null, \"aircraft\":null, \"crews\":null, \"pilots\":null}, seatMap=null, " +
                "status=ABANDONED, notifications=null, payment=null, passengers=null}sent by SMS";
        String actual = new SmsNotificationService().send(flightReservationReservationStatusAbandoned);
