...
public class PhotoRecord extends UpdatableRecordImpl<PhotoRecord> implements Record6<Long, String, Timestamp, Long, Long, Long> {

    private static final long serialVersionUID = 1670953729;
    ...
    @Override
    public Row6<Long, String, Timestamp, Long, Long, Long> valuesRow() {
    ...
    @Override
    public PhotoRecord values(Long value1, String value2, Timestamp value3, Long value4, Long value5, Long value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PhotoRecord(Long id, String photoPath, Timestamp creationDate, Long questionId, Long answerId, Long commentId) {
        super(PhotoTable.PHOTO_TABLE);
