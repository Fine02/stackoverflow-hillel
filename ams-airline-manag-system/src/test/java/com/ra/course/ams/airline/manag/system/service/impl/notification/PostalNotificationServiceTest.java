...
public class PostalNotificationServiceTest {
    ...
    public void whenNotificationWasNotModifiedThenThrowExeption() {
        ...
        Assertions.assertThrows(ReservationWasNotModifiedException.class, () ->
                new PostalNotificationService().send(flightReservationNotModifiedStatus));
    }
    ...
    public void whenFlightStatusIsCanceledThenReturnFlightReservationInfo() {
        String expected = "FlightReservation{reservationNumber='null', " +
                ...
                "status=CONFIRMED, notifications=null, payment=null, passengers=null}send by post office";
        String actual = new PostalNotificationService().send(flightReservationFlightStatusCancelrd);
    ...
    public void whenReservationStatusIsCanceledThenReturnFlightReservationInfo() {
        String expected = "FlightReservation{reservationNumber='null', " +
                ...
                " \"seats\":null, \"aircraft\":null, \"crews\":null, \"pilots\":null}, seatMap=null, " +
                "status=CANCELED, notifications=null, payment=null, passengers=null}send by post office";

        String actual = new PostalNotificationService().send(flightReservationReservationStatusCancelrd);
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void whenReservationStatusIsAbandonedThenReturnFlightReservationInfo() {
        String expected = "FlightReservation{reservationNumber='null', " +
                ...
                " \"departureTime\": \"null\", \"gate\": \"null\", \"status\":ARRIVED," +
                " \"seats\":null, \"aircraft\":null, \"crews\":null, \"pilots\":null}, seatMap=null, " +
                "status=ABANDONED, notifications=null, payment=null, passengers=null}send by post office";
        String actual = new PostalNotificationService().send(flightReservationReservationStatusAbandoned);
